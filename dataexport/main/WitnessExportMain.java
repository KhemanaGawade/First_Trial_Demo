...
import com.filevine.dataexport.service.WitnessExportService;

import util.DBProvider;

public class WitnessExportMain {

	public static void main(String[] args) {
		// TODO Auto-generated method stub

		System.out.println("\n=========================================================");
		System.out.println(" FILEVINE WITNSS DATA EXPORT ..... !!");
		System.out.println("=========================================================\n");
		WitnessExportService witnessexportservice=new WitnessExportService();
		...
		String response=witnessexportservice.getAdvanceClientCostExportResponse(cookie,projectID);
		witnessexportservice.getAdvanceClientCostData(response,database);
