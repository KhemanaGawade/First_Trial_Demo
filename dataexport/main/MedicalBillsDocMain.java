...
import com.filevine.dataexport.service.MedicalBillsDocService;

import util.DBProvider;

public class MedicalBillsDocMain {

	public static void main(String[] args) {
		
		System.out.println("\n=========================================================");
		System.out.println(" FILEVINE MEDICAL DOC DATA EXPORT ..... !!");
		System.out.println("=========================================================\n");

		MedicalBillsDocService medicalbillsdocservice=new MedicalBillsDocService();
		...
		String response=medicalbillsdocservice.getMedicalBillsDocResponse(cookie,projectID);
		medicalbillsdocservice.getMedicalBillsDocData(response,database);
