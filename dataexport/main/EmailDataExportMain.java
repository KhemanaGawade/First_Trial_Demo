...
import com.filevine.dataexport.service.EmailDataExportService;

import util.DBProvider;

public class EmailDataExportMain {
	...
	public static void main(String[] args) {
		...
		System.out.println("=========================================================\n");
		EmailDataExportService  emaildataexportservice =new EmailDataExportService ();
		...
		String response= emaildataexportservice.getEmailDataExportResponse(cookie,projectID);
		 emaildataexportservice.getAdvanceClientCostData(response,database);
