...
import com.filevine.dataexport.service.EmailNewDataService;

import util.DBProvider;

public class EmailNewDataMain {
	...
	public static void main(String[] args) {
			...
			System.out.println("=========================================================\n");
			EmailNewDataService advanceclientcostexportservice=new EmailNewDataService();
			...
			String response=advanceclientcostexportservice.getAdvanceClientCostExportResponse(cookie,projectID);
			advanceclientcostexportservice.getAdvanceClientCostData(response,database,projectID);
