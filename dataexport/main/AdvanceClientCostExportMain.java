...
public class AdvanceClientCostExportMain {

	public static void main(String[] args) {
		System.out.println("\n=========================================================");
		System.out.println(" FILEVINE CASE CLIENTCOST EXPORT ..... !!");
		System.out.println("=========================================================\n");
		AdvanceClientCostExportService advanceclientcostexportservice=new AdvanceClientCostExportService();
		...
		advanceclientcostexportservice.getAdvanceClientCostData(response,database);
