...
import com.filevine.dataexport.service.InsuranceDataExportService;

import util.DBProvider;



public class InsuranceDataExportMain {
	...
	public static void main(String[] args) {
		...
		System.out.println("=========================================================\n");
		InsuranceDataExportService insurancedataexportservice=new InsuranceDataExportService();
		...
		String response=insurancedataexportservice.getInsuranceDataExportResponse(cookie,projectID);
		insurancedataexportservice.getInsuranceData(response,database);
