...
import com.filevine.dataexport.service.LiensExportService;

import util.DBProvider;



public class LiensExportMain {

	public static void main(String[] args) {
		
		System.out.println("\n=========================================================");
		System.out.println(" FILEVINE CASE LIENS EXPORT ..... !!");
		System.out.println("=========================================================\n");
		LiensExportService  liensexportservice =new LiensExportService ();
		...
		String response=liensexportservice.getLiensExportResponse(cookie,projectID);
		liensexportservice.getLiensExportData(response,database);
