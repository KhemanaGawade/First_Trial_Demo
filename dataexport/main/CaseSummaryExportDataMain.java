...
public class CaseSummaryExportDataMain {
	...
	public static void main(String[] args) {
		...
		System.out.println("=========================================================\n");
		CaseSummaryExportDataService casesummaryexportdataservice=new CaseSummaryExportDataService();
		...
		String response=casesummaryexportdataservice.getCaseSummaryExportResponse(cookie,projectID);
		casesummaryexportdataservice.getCaseSummaryData(response,database);
