...
import com.filevine.dataexport.service.DefendantsExportService;


import util.DBProvider;

public class DefendantsExportMain {
	...
	public static void main(String[] args) {
		...
		System.out.println("\n=========================================================");
		System.out.println(" FILEVINE DEFENDANTS DATA EXPORT ..... !!");
		System.out.println("=========================================================\n");
		DefendantsExportService defendantsexportservice=new DefendantsExportService();
		...
		String response=defendantsexportservice.getDefendantsClientCostExportResponse(cookie,projectID);
		defendantsexportservice.getDefendantsClientCostData(response,database);
