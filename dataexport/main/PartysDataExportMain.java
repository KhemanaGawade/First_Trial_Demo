...
import com.filevine.dataexport.service.PartysDataExportService;

import util.DBProvider;

public class PartysDataExportMain {

	public static void main(String[] args) {
		
		System.out.println("\n=========================================================");
		System.out.println(" FILEVINE PARTYS DATA EXPORT ..... !!");
		System.out.println("=========================================================\n");
		 
		PartysDataExportService  partysdataexportservice=new  PartysDataExportService();
		...
		System.out.println("Please enter batch : ");
			...
			String response= partysdataexportservice.getPartysDataExportResponse(cookie, projectID);
			partysdataexportservice.getPartysData(response,database);
