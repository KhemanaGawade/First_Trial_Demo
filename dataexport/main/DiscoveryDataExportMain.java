...
import com.filevine.dataexport.service.DiscoveryDataExportService;
import com.filevine.dataexport.service.MedicalBillsDataExportService;

import util.DBProvider;

public class DiscoveryDataExportMain {

	public static void main(String[] args) {
	
		System.out.println("\n=========================================================");
		System.out.println(" FILEVINE DISCOVERY DATA EXPORT ..... !!");
		System.out.println("=========================================================\n");
		DiscoveryDataExportService discoverydataexportservice =new DiscoveryDataExportService ();
		...
		String response=discoverydataexportservice.getDiscoveryDataExportResponse(cookie,projectID);
		discoverydataexportservice.getDiscoveryData(response,database);
