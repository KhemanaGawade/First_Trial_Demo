...
public class PleadingsDataExportMain {

	public static void main(String[] args) {
		System.out.println("\n=========================================================");
		System.out.println(" FILEVINE PLEADING DATA  EXPORT ..... !!");
		System.out.println("=========================================================\n");
		PleadingsDataExportService  pleadingsdataexportservice =new PleadingsDataExportService ();
		...
		String response=pleadingsdataexportservice.getPleadingsDataExportResponse(cookie,projectID);
		pleadingsdataexportservice.getAdvanceClientCostData(response,database);
